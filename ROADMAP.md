...
- [ ] Add metadata and static files (imgs)
- [ ] Configure shadcn
- [ ] Configure prisma-orm
- [ ] Import migrations from server project
- [ ] Create "sessions" table
- [ ] Create privates and public routes
- [ ] Create authentication functionality
- [ ] Create app layout
- [ ] Create file import functionality (using firebase storage)
- [ ] Configure test suit with vitest and dockerfile
- [ ] Create users module (UI/Back)
- [ ] Create whatsapp service
- [ ] Create permissions control
